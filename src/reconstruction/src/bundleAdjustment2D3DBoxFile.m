function [cameraRtC2W,pointCloud,focalLen] = bundleAdjustment2D3DBoxFile(cameraRtC2W,pointCloud,pointObserved, pointObservedValue, K, weight, mode)
...
fname_inout = tempname;%['./file/' num2str(round(1000*rand(1)))];
